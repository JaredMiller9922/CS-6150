...
\textbf{Using the innequality we are given for $r_i$ and some algebra gives us the solution}

\begin{align*}
  r_i &\ge \mu + 2 \sigma \\
  |r_i - \mu| &\ge 2 \sigma 
\end{align*}
\textbf{Now plug into Chebyshev}

\begin{align*}
  &Pr[|X-\mu| \ge k \sigma] \le \frac{1}{k^2} \\
  &Pr[|r_i-\mu| \ge 2 \sigma] \le \frac{1}{2^2} \\
