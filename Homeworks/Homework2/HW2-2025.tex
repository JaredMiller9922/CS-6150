...
\textbf{Inputs to set cover $(P,S,m,M)$}

\textbf{P: Vertices representing people $\rightarrow$ V: Vertices representing nodes of graph}

\textbf{M: Set of desired skills $\rightarrow$ E: Set of edges representing streets}

\textbf{m: Set of edges $(u,v)$ such that person $u$ covers skill $v \in M$ $\rightarrow$ m: set of edges $(u,v)$ such that node $u$ is incident to street $v$}

\textbf{Output of street surveillance: Subset of nodes that cover all edges $\rightarrow$ Output of set cover: Subset of people that cover all skills}

\textbf{I talked with Yash and he reccomended the approach above. I have still left my previous explanation for "extra work"}
